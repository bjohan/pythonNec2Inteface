class NecFileGenerator:
	...
	def transmissionLine(self, tag1, seg1, tag2, seg2, zc, l=0, ra1=0, ia1=0, ra2=0, ia2=0):
		self.geometryData+="TL\t%d\t%d\t%d\t%d\t%e\t%e\t%e\t%e\t%e\t%e"%(tag1, seg1, tag2, seg2, zc, l, ia1, ra1, ia2, ra2)
